...
def insufficient_data(engine_name: str, source_document: SourceDocument) -> AnswerResult:
    return AnswerResult(
        answer=(
            f"insufficient data: {engine_name} extraction engine is not implemented yet "
